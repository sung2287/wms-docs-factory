...
## 7. Operational SSOT (UI Serving)
- **Delegation**: Dev/Prod UI serving(5173/3000) 및 `ui:build` pre-req는 README.md의 “Development vs Production UI Serving” 섹션을 **SSOT**로 위임한다.
